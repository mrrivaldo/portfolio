...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      title: "Bug Hunting",
      description:
        "Certificate of Appreciation for finding vulnerabilities in Jembrana Government Website",
    ...
    },
    {
      ...
      title: "Bug Hunting",
      description:
        "Certificate of Appreciation for finding vulnerabilities in one of the Bantul Government Website",
      category: "Vulnerability Disclosure",
    ...
    },
    {
      ...
      title: "Bug Hunting",
      description:
        "Certificate of Appreciation for finding vulnerabilities in one of the Pontianak Government Website",
      category: "Vulnerability Disclosure",
    ...
    },
    {
      ...
      description: "Complete company profile with vite react and tailwindcss",
            ...
            <div key={project.id} className="project-card reveal">
              <div className="group relative overflow-hidden border border-gray-800 hover:border-neon-green transition-all duration-300">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4 sm:p-6">
                  <span className="text-neon-green text-xs sm:text-sm mb-2">
                    {project.category}
                  </span>
                  <h3 className="text-xl sm:text-2xl font-condensed mb-2">
                    {project.title}
                  </h3>
